    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
                Back-end web developer based in Bangkok.
            </h1>

            <p className='max-w-2x1 mx-auto font-Ovo'>
                I am a Report developer from bangkok, Thailand with 2 years of exprience specializing in report development.
                Currently seeking new opportunities to grow and advance skills as a Backend Developer.
            </p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <a href="#/sample-resume.pdf" download className='px-10 py-3 border rounded-full border-grey-500 flex items-center gap-2'>
